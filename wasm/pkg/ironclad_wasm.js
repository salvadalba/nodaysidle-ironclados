 ...
 * @returns {any}
 */
export function executeDemo(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.executeDemo(ptr0, len0);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_522a96f1a673675b = function() { return logError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ironclad_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
